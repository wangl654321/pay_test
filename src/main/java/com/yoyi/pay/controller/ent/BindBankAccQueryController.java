...
@Controller
@RequestMapping("/ent")
public class BindBankAccQueryController {
    ...
    @RequestMapping(value = "/bankAccQuery")
    public String toJsp() {
        return "ent/bind_bank_acc_query";
    }

    /**
     * 已绑定银行账户查询,将参数封装成tranData
     *
     * @param request
     * @return
     */
    ...
    @ResponseBody
    @RequestMapping(value = "/saveBankAccQuery")
    public String registered(HttpServletRequest request) {
        ...
        logger.info("已绑定银行账户查询,将参数封装成tranData,请求地址,{}", regUrl);
        ...
        try {
            ...
            logger.info("已绑定银行账户查询,将参数封装成tranData,xml,{}", xml);
            //订单签名数据
            ...
            logger.info("已绑定银行账户查询,将参数封装成tranData,处理中");
            ...
            logger.info("已绑定银行账户查询,调取接口返回密文,{}", value);
            ...
            logger.error("已绑定银行账户查询,将参数封装成tranData,异常{}", e);
        }
        return result;
    }
}
