...
@Controller
@RequestMapping("/ent")
public class BindBankAccController {
     ...
     * @return
     */
    @RequestMapping(value = "/bindBankAcc")
    public String toJsp() {
        return "ent/bind_bank_acc";
    }

    /**
     * 企业账户绑定,将参数封装成tranData
     *
     * @param request
     * @return
     */
    @ResponseBody
    @RequestMapping(value = "/saveBindBankAcc")
    public String registered(HttpServletRequest request) {


        Map<String, String[]> parameterMap = request.getParameterMap();
        Map<String, String> params = new HashMap<>(8);
        logger.info("企业账户绑定,将参数封装成tranData,开始");
        //商户代码
        ...
        try {
            ...
            logger.info("企业账户绑定,将参数封装成tranData,xml,{}", xml);
            //订单签名数据
            ...
            logger.info("企业账户绑定,将参数封装成tranData,处理中");
            ...
            logger.info("企业账户绑定,调取接口返回密文,{}", value);
            String decode = Base64Utils.decode(value);
            logger.info("企业账户绑定,返回,{}", decode);
            Map<String, String> map = YoYiPayUtil.xmlParse(decode);

            result = json.toJson(map);
            logger.info("企业账户绑定,调取接口返回明文,{}", result);
        } catch (Exception e) {
            logger.error("企业账户绑定,将参数封装成tranData,异常{}", e);
        }
        return result;
    }
}
