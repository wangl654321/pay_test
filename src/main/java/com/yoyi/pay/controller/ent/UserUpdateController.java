...
public class UserUpdateController {
     ...
     * @return
     */
    @RequestMapping(value = "/corApiRegistUpdate")
    public String toJsp() {
        return "ent/user_update";
    }

    /**
     * 企业信息修改,将参数封装成tranData
     *
     * @param request
     * @return
     */
    @ResponseBody
    @RequestMapping(value = "/saveCorApiRegistUpdate")
    public String registered(HttpServletRequest request) {

        Map<String, String[]> parameterMap = request.getParameterMap();
        Map<String, String> params = new HashMap<>(32);
        logger.info("企业信息修改,将参数封装成tranData,开始");
        ...
        try {
            ...
            logger.info("企业信息修改,将参数封装成tranData,xml,{}", xml);
            //订单签名数据
            ...
            logger.info("企业信息修改,将参数封装成tranData,处理中");
            ...
            logger.info("企业信息修改,调取接口返回密文,{}", value);
            String decode = Base64Utils.decode(value,"UTF-8");
            logger.info("企业信息修改,返回,{}", decode);
            result = decode;
            logger.info("企业信息修改,调取接口返回明文,{}", result);
        } catch (Exception e) {
            logger.error("企业信息修改,将参数封装成tranData,异常{}", e);
        }
        return result;
    }
}
