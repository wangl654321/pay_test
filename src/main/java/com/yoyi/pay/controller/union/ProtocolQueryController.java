...
public class ProtocolQueryController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/saveProtocolQuery")
    public String registered(HttpServletRequest request) {
        ...
        String transIP = "";
        logger.info("协议查询,将参数封装成tranData,请求地址,{}", regUrl);
        ...
        try {
            ...
            logger.info("协议查询,将参数封装成tranData,xml,{}", xml);
            //订单签名数据
            ...
            logger.info("协议查询,将参数封装成tranData,处理中");
