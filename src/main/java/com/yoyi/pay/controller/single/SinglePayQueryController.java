...
public class SinglePayQueryController {
    ...
    public String toJsp() {
        return "single/singe_pay_query";
    }

    /**
     * 单笔汇款查询接口将参数封装成tranData
     *
     * @param request
     * @return
     */
    @ResponseBody
    @RequestMapping(value = "/saveSinglePayQuery")
    public String registered(HttpServletRequest request) {
        ...
        logger.info("单笔汇款查询接口,将参数封装成tranData,请求地址,{}", regUrl);
        ...
        try {
            ...
            logger.info("单笔汇款查询接口,将参数封装成tranData,xml,{}", xml);
            //订单签名数据
            ...
            logger.info("单笔汇款查询接口,将参数封装成tranData,处理中");
            ...
            logger.info("单笔汇款查询接口,调取接口返回明文,{}", result);
        } catch (Exception e) {
            logger.error("单笔汇款查询接口,将参数封装成tranData,异常{}", e);
        }
        return result;
    }
}