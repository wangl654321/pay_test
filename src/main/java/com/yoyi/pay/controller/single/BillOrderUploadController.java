...
public class BillOrderUploadController {
     ...
     * @return
     */
    @RequestMapping(value = "/billOrderUpload")
    public String toJsp() {
        return "single/bill_order_upload";
    }

    /**
     * 单笔票据上传,将参数封装成tranData
     *
     * @param request
     * @return
     */
    @ResponseBody
    @RequestMapping(value = "/saveBillOrderUpload")
    public String registered(HttpServletRequest request) {
        ...
        //interfaceName
        logger.info("单笔票据上传,将参数封装成tranData,请求地址,{}", regUrl);
        ...
        try {
            ...
            logger.info("单笔票据上传,将参数封装成tranData,xml,{}", xml);
            //订单签名数据
            ...
            logger.info("单笔票据上传,将参数封装成tranData,处理中");
            ...
            logger.info("单笔票据上传,调取接口返回明文,{}", result);
        } catch (Exception e) {
            logger.error("单笔票据上传,将参数封装成tranData,异常{}", e);
        }
        return result;
    }
}