...
public class QueryRefundOrderController {
    ...
    public String toJsp() {
        return "withholding/query_refund_order";
    }

    /**
     * 退款订单查询,将参数封装成tranData
     *
     * @param request
     * @return
     */
    ...
    public String registered(HttpServletRequest request) {
        ...
        logger.info("退款订单查询,将参数封装成tranData,请求地址,{}", regUrl);
        ...
        try {
            ...
            logger.info("退款订单查询,将参数封装成tranData,xml,{}", xml);
            //订单签名数据
            ...
            logger.info("退款订单查询,将参数封装成tranData,处理中");
            ...
            logger.info("退款订单查询,调取接口返回明文,{}", result);
        } catch (Exception e) {
            logger.error("退款订单查询,将参数封装成tranData,异常{}", e);
        }
        return result;
    }
}