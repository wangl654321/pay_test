...
public class OrderQueryController {
    ...
    public String toJsp() {
        return "withholding/order_query";
    }
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/saveOrderQuery")
    public String registered(HttpServletRequest request) {
        ...
        logger.info("订单查询,将参数封装成tranData,请求地址,{}", regUrl);
        ...
        try {
            ...
            logger.info("订单查询,将参数封装成tranData,xml,{}", xml);
            //订单签名数据
            ...
            logger.info("订单查询,将参数封装成tranData,处理中");
            ...
            logger.info("订单查询,调取接口返回明文,{}", result);
        } catch (Exception e) {
            logger.error("订单查询,将参数封装成tranData,异常{}", e);
        }
        return result;
    }
}