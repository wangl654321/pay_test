...
public class UnWithHoldSignController {
     ...
     * @return
     */
    @RequestMapping(value = "/withholdSignCancel")
    public String toJsp() {
        return "withholding/un_withhold_sign";
    }
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/saveWithholdSignCancel")
    public String registered(HttpServletRequest request) {
        ...
        logger.info("代扣解约,将参数封装成tranData,请求地址,{}", regUrl);
        ...
        try {
            ...
            logger.info("代扣解约,将参数封装成tranData,xml,{}", xml);
            //订单签名数据
            ...
            logger.info("代扣解约,将参数封装成tranData,处理中");
