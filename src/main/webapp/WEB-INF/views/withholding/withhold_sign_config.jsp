...
<div class="main">
    <div class="quickAPI">
        <form id="fromId" method="post">
            ...
            <h3>支付请求 请求参数</h3>
            <p><label>测试地址:</label><input id="regUrl" type="text" value="${test}/pay/withholdSign.do"   placeholder="必填"/></p>

            <p><label>商户代码:</label><input name="merchantId" id="merchantId" type="text" value="${merchantId}" placeholder="必填"/></p>
            <p><label>接口名称:</label><input name="interfaceName" id="interfaceName" type="text" value="withholdSign" placeholder="必填"/></p>
