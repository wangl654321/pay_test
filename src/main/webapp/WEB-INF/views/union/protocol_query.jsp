...
<div class="main">
    <div class="quickAPI">
        <form id="fromId" method="post" action="${ctx}/union/saveProtocolQuery">
            <h3>协议查询 请求参数</h3>

            <p><label>测试地址:</label><input name="regUrl" id="regUrl" type="text" value="${test}/pay/protocolQuery.do" class="check_required"  placeholder="必填"/></p>

            <p><label>商户代码:</label><input name="merchantId" id="merchantId" type="text" value="${yMerchantId}" class="check_required" placeholder="必填"/></p>
            <p><label>接口名称:</label><input name="interfaceName" id="interfaceName" type="text" value="checkBindInfo" class="check_required" placeholder="必填"/></p>
            ...
            <p><label>付款账号:</label><input name="payCardNo" id="payCardNo" type="text" class="check_required" placeholder="必填"/></p>
