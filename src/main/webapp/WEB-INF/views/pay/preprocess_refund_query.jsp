...
<div class="main">
    <div class="quickAPI">
        <form id="fromId" method="post" action="${ctx}/toYoYi/savePreprocessRefundOrderQuery">
            <h3>支付退款查询 请求参数</h3>
            <p><label>测试地址:</label>

            <input name="regUrl" id="regUrl" type="text" value="${test}/pay/QueryRefundOrder.do" placeholder="必填"/></p>
