...
<div class="main">
    <div class="quickAPI">
        <form id="fromId" method="post" action="${ctx}/protocol/saveProtocolSign" >
            <h3>支付协议签约 请求参数</h3>
            ...
            <p><label>协议生效时间:</label>
                <input name="tranDate" id="tranDate" type="text" value="<%=new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()) %>" required="required"/>
            </p>
            <p><label>客户类型:</label><input name="customerType" id="customerType" type="text" value="P" placeholder="客户类型" required="required"/></p>
            <p><label>卡折标志:</label>
