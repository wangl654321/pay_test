...
<div class="main">
    <div class="quickAPI">
        <form id="fromId" method="post" action="${ctx}/ent/saveUserSettingApi">

            <h3>账号设置 请求参数</h3>
            <p><label>测试地址:</label>
                <input name="regUrl" id="regUrl" type="text" value="${test}/ent/userSettingApi.do" placeholder="必填" class = "check_required"/>
            </p>
            <p><label>商户代码:</label>
