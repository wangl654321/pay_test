...
<div class="main">
    <div class="quickAPI">
        <form id="fromId" method="post" action="${ctx}/ent/saveUnBindWhiteCard">

            <h3>会员白名单卡状态修改 请求参数</h3>
            <p><label>测试地址:</label>
                <input name="regUrl" id="regUrl" type="text" value="${test}/ent/unBindWhiteCard.do" class="check_required" placeholder="必填"/>
            </p>
            <p><label>商户代码:</label>
