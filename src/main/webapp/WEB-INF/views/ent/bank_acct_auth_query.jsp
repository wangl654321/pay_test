...
<div class="main">
    <div class="quickAPI">
        <form id="fromId" method="post" action="${ctx}/ent/saveBankAcctAuthQuery">

            <h3>企业账户打款结果查询 请求参数</h3>
            <p><label>测试地址:</label>
                <input name="regUrl" id="regUrl" type="text" value="${test}/pay/corAcctAuthQuery.do" class="check_required" placeholder="必填"/>
            </p>
            <p><label>商户代码:</label>
