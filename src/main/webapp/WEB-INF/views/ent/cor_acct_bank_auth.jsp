...
<div class="main">
    <div class="quickAPI">
        <form id="fromId" method="post" action="${ctx}/ent/saveCorAcctBankAuth">

            <h3>企业账户打款认证(已绑定银行账户) 请求参数</h3>
            <br><br>
            <p><label>测试地址:</label>
                <input name="regUrl" id="regUrl" type="text" value="${test}/pay/corAcctBankAuth.do" class="check_required" placeholder="必填"/>
            </p>
            <p><label>商户代码:</label>
