...
<div class="main">
    <div class="quickAPI">
        <form id="fromId" method="post" action="${ctx}/ent/userRegisterQuery">

            <h3>企业信息查询 请求参数</h3>
            <p><label>测试地址:</label>
                <input name="regUrl" id="regUrl" type="text" value="${test}/ent/corApiQuery.do" class="check_required" placeholder="必填"/>
            </p>
            ...
            <p><label>会员客户号:</label>
                <input name="customerId" id="customerId" type="text" placeholder="非必填"/>
            </p>
            <p><label>公司名称:</label>
                <input name="company" id="company" type="text" placeholder="非必填"/>
            </p>
