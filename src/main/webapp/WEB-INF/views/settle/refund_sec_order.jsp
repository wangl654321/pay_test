...
<div class="main">
    <div class="quickAPI">
        <form id="fromId" method="post" action="${ctx}/settle/saveRefundSecOrder">
            <h3>(结算通)退款 请求参数</h3>
            <p><label>测试地址:</label>

            <input name="regUrl" id="regUrl" type="text" value="${test}/pay/refundSecOrder.do" placeholder="必填"/></p>

            <p><label>商户代码:</label><input name="merchantId" id="merchantId" type="text"value="${yMerchantId}" class="check_required"  placeholder="必填"/></p>
            <p><label>接口名称:</label><input name="interfaceName" id="interfaceName" type="text" value="SecRefundOrder"  placeholder="必填"/></p>
            ...
            <p><label>订单退款金额:</label><input name="refundAmt" id="refundAmt" type="text" class="check_required" placeholder="必填"/></p>

            <p><label>退还买/卖手续费:</label>
                <select name="isReturnFee" id="isReturnFee">
                    <option value="0">不退还</option>
                    <option value="3">全退</option>
                </select>
            </p>
            <p><label>退款说明:</label><input name="remark" id="remark" type="text" placeholder="非必填"/></p>
